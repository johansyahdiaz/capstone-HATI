...
const StorePage = {
  ...
  async afterRender() {
    ...
    <div class="store-contact">
        ...
        <p><img src="./Images/ig.png" style="max-width:25px;border:none;border-radius:0;"> <p class="text-instagram">${store.socmed ? store.socmed : 'This store has no instagram.</p>'}</p>
    </div>
    `;
