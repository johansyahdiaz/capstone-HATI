...
import OrderData from '../utils/order-data'; // Mengimpor order-data untuk feedback
...
const DetailProductPage = {
  ...
  async afterRender() {
    try {
      ...
      // Fetch feedback from OrderData
      const feedback = await OrderData.getProductFeedback(product.id);
      console.log('Product Feedback:', feedback);
